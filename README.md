...
# <img width="32" height="32" alt="image" src="https://github.com/user-attachments/assets/547f90b3-d052-4ad6-a3cb-9ad9801555e1" style="vertical-align: middle;" /> Sketch VC
...
<img width="1296" height="1150" alt="image" src="https://github.com/user-attachments/assets/5da448f4-dd4b-4893-8a98-721b2f40a345" />
...
```env
VITE_API_URL=https://your-deployed-api-service
VITE_PROXY_URL=https://your-deployed-proxy-service
```
